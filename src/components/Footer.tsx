...
function Footer() {
  return (
    <footer className="w-full bg-[#6E56CF] ">
      <div className="flex flex-col md:flex-row justify-evenly items-center py-4 gap-4">
        <div className=" w-full flex flex-row justify-evenly">
          <a
            href="https://www.linkedin.com/in/mustapha-salmi-06644a147/"
            target="_blank"
